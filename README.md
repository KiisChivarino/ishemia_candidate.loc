...
<h3>Мониторинг приема лекарств:</h3>
...
<h3>Мониторинг приемов у врача:</h3>
...
<h2>Требования к техническому исполнению:</h2>
...
<h3>Страницы кабинета пациента</h3>

<h4>Общие элементы</h4>
...
<h4>Страница обследования (аналогично для каждого подпункта):</h4>
...
<h4>Страница «История болезни»</h4>
...
<h5>Окно Внести документальные данные</h5>

<h6>Форма внесения документальных данных</h6>
...
<h4>Страница «Назначить лечение»:</h4>
...
<h4>Страница «Приемы пациента»</h4>
