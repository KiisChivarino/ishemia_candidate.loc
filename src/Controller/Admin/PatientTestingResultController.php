...
class PatientTestingResultController extends AdminAbstractController
{
    ...
    )
    {
        ...
        $this->templateService = new PatientTestingResultTemplate(
    ...
    public function edit(Request $request, PatientTestingResult $patientTestingResult): Response
    {
        return $this->responseEditMultiForm(
            ...
            $patientTestingResult,
            [
                new FormData(PatientTestingResultType::class, $patientTestingResult, [
                    'patientTestingResult' => $patientTestingResult
                ]),
                new FormData(EnabledType::class, $patientTestingResult)
            ]
        );
    }
