...
class MedicalHistoryController extends DoctorOfficeAbstractController
{
     ...
     * @throws Exception
     */
    public function editDischargeEpicrisis(Request $request, PatientDischargeEpicrisis $dischargeEpicrisis, PatientTestingFileRepository $patientTestingFileRepository)
    {
