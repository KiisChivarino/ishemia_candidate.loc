 ...
 */
class NotificationReceiverTypeRepository extends ServiceEntityRepository
{
    ...
    // /**
    //  * @return NotificationReceiverType[] Returns an array of NotificationReceiverType objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?NotificationReceiverType
    {
        return $this->createQueryBuilder('n')
            ->andWhere('n.exampleField = :val')
            ->setParameter('val', $value)
