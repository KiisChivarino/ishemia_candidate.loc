...
class UserRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
     ...
     * @param string $authUserFormName
     * @param string $authUserRoleFormName
     * @throws Exception
     */
    public function addUserFromAdmin(FormInterface $form, string $authUserFormName, string $authUserRoleFormName): void
    {
        try {
            $data = $form->getData();
            /** @var AuthUser $authUser */
            $authUser = $data[$authUserFormName];
            if (!is_a($authUser, AuthUser::class)) {
